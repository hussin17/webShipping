...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">أضافة محافظة شحن</h2>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('shippingStates.store') }}" method="POST" class="parsley-style-1" id="selectForm2"
                        name="selectForm2">
                        @csrf
                        <div class="">
                            <div class="row mg-b-20">
                                ...
                                <div class="parsley-input col-md-6">
                                    ...
                                    <select autofocus class="form-control" name="state_id">
                                        <option value="">اختر...</option>
                                ...
                                <div class="parsley-input col-md-6">
                                    ...
                                    <input autofocus class="form-control" name="shippingValue" value="{{ old('shippingValue') }}"  type="text">
                                    @error('shippingValue')
