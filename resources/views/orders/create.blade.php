...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <div>
                <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">أضافة طلبية</h2>
            </div>
        </div>
    </div>
    <!-- /breadcrumb -->
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('orders.store') }}" method="POST" class="parsley-style-1" id="selectForm2"
                        name="selectForm2">
                        @csrf
                        <div class="">
                            <div class="row mg-b-20">
                                ...
                                <div class="parsley-input col-md-4">
                                    <label>مكان الاستلام: <span class="tx-danger">*</span></label>
                                    <textarea name="details_address" class="form-control" placeholder="العنوان التفصيلي"></textarea>
                                </div>
                                <div class="parsley-input col-md-4">
                                    <label>المبلغ: <span class="tx-danger">*</span></label>
                                    <input type="text" placeholder="مبلغ الطلبية" class="form-control" name="mount" required="true">
                                    @error('mount')
                                ...
                                <div class="parsley-input col-md-4">
                                    <label>الحجم: </label>
                                    <input type="text" placeholder="حجم الطلبية" class="form-control" name="size">
                                </div>
                                <div class="parsley-input col-md-4">
                                    <label>الوزن: </label>
                                    <input type="text" placeholder="وزن الطلبية" class="form-control" name="weight">
                                </div>
                                <div class="parsley-input col-md-12">
                                    <label>ملاحظات: </label>
                                    <textarea type="text" placeholder="ملاحظات" class="form-control" name="notes"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="mg-t-30">
